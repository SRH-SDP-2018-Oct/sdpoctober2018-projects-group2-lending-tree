...
public class ConnectMSSQLServer {
    private static String databaseURL = "jdbc:sqlserver://localhost:1433;DatabaseName=master";
    ...
    public static void executeSQLSentence(String sentence) throws SQLException {
        Statement dbStatement = databaseConnection.createStatement();
        System.out.println(sentence);
        dbStatement.executeQuery(sentence);
    }
    ...
    public static int insertCustomer(Customer newCustomer) throws SQLException {
        ConnectMSSQLServer.executeSQLSentence("INSERT INTO customer (customer_type_id, customer_last_name, customer_first_name, customer_address, customer_email, customer_phone, customer_current_expenses, customer_pay_slip, customer_tax_details, customer_identification_number, customer_rating, customer_password) " +
