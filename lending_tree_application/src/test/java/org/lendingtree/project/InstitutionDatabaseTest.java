...
public class InstitutionDatabaseTest {
    ...
    public void writeToDbTest(){
        ...
        try{
            ...
            institution.setId(InstitutionDatabase.insert(institution));
    ...
    public void readFromDbTest(){
        ...
        try{
            institution = InstitutionDatabase.getInstitution(institutionId);
